    ...
    */
    ...
    function $_taskSortable() {
        $('[data-sortable="true"]').sortable({
            ...
            update: function( event, ui ) {
                ...
                var presupuestoId = ui.item.attr('id').split('-')[1];
                var nuevoEstadoId = ui.item.closest('[data-section]').attr('data-section').split('-')[1];

                // Llamada a Livewire para actualizar el estado
                Livewire.emit('actualizarEstado', presupuestoId, nuevoEstadoId);
            }
        });
    }
    ...
    function $_taskAdd( getParent ) {
        ...
        $('[data-btnfn="addTask"]').off('click').on('click', function(event) {
            ...
            let getAddBtnClass = $(this).attr('class').split(' ')[1];
    ...
    $(".add-list").off('click').on('click', function(event) {
        ...
        let $html = '<div data-section="s-'+$_listSectionDataAttr+'" class="task-list-container  mb-4 " data-connect="sorting">'+
