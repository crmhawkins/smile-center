        ...
        if ($this->pack_seleccionado != 0) {
            ...
            if ($existe) {
                ...
                $this->listaPacks[] = [
                    ...
                    'tiempos' => !empty($this->tiemposPack) ? $this->tiemposPack : $defaultDoubleArray,
                    'horas_inicio' => !empty($this->horasInicioPack) ? $this->horasInicioPack : $defaultDoubleArray,
                    'horas_finalizacion' => !empty($this->horasFinalizacionPack) ? $this->horasFinalizacionPack : $defaultDoubleArray,
                    'tiempos_montaje' => !empty($this->tiemposMontajePack) ? $this->tiemposMontajePack : $defaultDoubleArray,
                    'tiempos_desmontaje' => !empty($this->tiemposDesmontajePack) ? $this->tiemposDesmontajePack : $defaultDoubleArray,
                    'horas_montaje' => !empty($this->horasMontajePack) ? $this->horasMontajePack : $defaultDoubleArray,
                    'id_monitores' => !empty($this->idMonitoresPack) ? $this->idMonitoresPack : $defaultArray,
                    'sueldos_monitores' => !empty($this->sueldoMonitoresPack) ? $this->sueldoMonitoresPack : $defaultArray,
                    'gastos_gasoil' => !empty($this->gastosGasoilPack) ? $this->gastosGasoilPack : $defaultArray,
                    'checks_gasoil' => !empty($this->gastosGasoilPack) ? $this->gastosGasoilPack : $defaultArray,
                    'pagos_pendientes' => !empty($this->sueldoMonitoresPack) ? $this->sueldoMonitoresPack : $defaultArray,
