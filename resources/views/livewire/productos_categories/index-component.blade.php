...
@section('content')
    <div class="container mx-auto">
        <div class="d-flex justify-content-left align-items-center">
            <h1 class="me-5">Productos - Categorías</h1>
            <a href="{{ route('productos-categories.create') }}" class="btn btn-info text-white rounded-circle"><i
        ...
        @if (count($productosCategories) > 0)
