<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">EDITAR CITA</span></h4>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-md-3">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="w-100 btn btn-success mb-2" id="alertaGuardar">Actualizar Cita</button>
                            <button class="w-100 btn btn-danger mb-2" wire:click="destroy">Borrar Cita</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        $("#alertaGuardar").on("click", () => {
            Swal.fire({
                title: '¿Estás seguro?',
                text: 'Pulsa el botón de confirmar para actualizar la cita.',
                icon: 'warning',
