...
<div class="container mx-auto">
    ...
    <form wire:submit.prevent="update">
        ...
        <div class="mb-3 row d-flex align-items-center">
            <label for="minMonitor" class="col-sm-2 col-form-label">Empleados mínimos </label>
            <div class="col-sm-10">
                <input type="number" wire:model="minMonitor" class="form-control" name="minMonitor" id="minMonitor"
                    placeholder="1">
                @error('minMonitor')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <div class="mb-3 row d-flex align-items-center">
            ...
            <div class="col-sm-10">
                <input type="number" wire:model="precioMonitor" class="form-control" name="precioMonitor" id="precioMonitor"
                    placeholder="1">
                @error('precioMonitor')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
        ...
        <div class="mb-3 row d-flex align-items-center">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="precioTotal" id="precioTotal"
                    placeholder="1" disabled value="{{ $this->precioTotal($identificador) }}">
            </div>
        </div>
