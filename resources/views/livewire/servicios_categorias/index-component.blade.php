    ...
    <div class="row">
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Listado de todas las categorias de servicios</h4>
                    ...
                    @if (count($serviciosCategorias) > 0)
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($serviciosCategorias as $servicio)
                                    <tr>
                                        <td>{{ $servicio->nombre }}</td>


                                        <td> <a href="servicios-categorias-edit/{{ $servicio->id }}" class="btn btn-primary">Ver/Editar</a> </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
