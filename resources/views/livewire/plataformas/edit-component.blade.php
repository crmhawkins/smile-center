        ...
        <div class="col-md-3">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="button" class="w-100 btn btn-success mb-2" id="alertaGuardar">Guardar Plataforma</button>
                            <button type="button" class="w-100 btn btn-danger mb-2" wire:click='destroy'>Borrar Plataforma</button>
                        </div>
                    </div>
                </div>
            </div>
