<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">CREAR PLATAFORMA</span></h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Plataformas</a></li>
                    <li class="breadcrumb-item active">Crear platafroma</li>
                </ol>
            </div>
        </div> <!-- end row -->
    </div>
        ...
        <div class="col-md-3">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="w-100 btn btn-success mb-2" id="alertaGuardar">Guardar Plataforma</button>
                        </div>
                    </div>
                </div>
            </div>
