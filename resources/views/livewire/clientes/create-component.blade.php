                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                @if ($tipo_cliente != 0)
                                    <div class="col-sm-4">
                                        <label for="example-text-input" class="col-sm-12 col-form-label">Código Órgano
                                            Gestor</label>
                                        <div class="col-sm-12">
                                            <input type="text" wire:model="codigo_organo_gestor"
                                                class="form-control" name="codigo_organo_gestor"
                                                id="codigo_organo_gestor" aria-label="Nombre" placeholder="Nombre">
                                            @error('nombre')
                                                <span class="text-danger">{{ $message }}</span>
                                                <style>
                                                    .nombre {
                                    ...
                                    <div class="col-sm-4">
                                        <label for="example-text-input" class="col-sm-12 col-form-label">Código Unidad
                                            Tramitadora</label>
                                        <div class="col-sm-12">
                                            <input type="text" wire:model="codigo_unidad_tramitadora"
                                                class="form-control" name="codigo_unidad_tramitadora"
                                                id="codigo_unidad_tramitadora" aria-label="Nombre"
                                                placeholder="Nombre">
                                            @error('nombre')
                                                <span class="text-danger">{{ $message }}</span>
                                                <style>
                                    ...
                                    <div class="col-sm-4">
                                        <label for="example-text-input" class="col-sm-12 col-form-label">Códigos
                                            Oficina Contable</label>
                                        <div class="col-sm-12">
                                            <input type="text" wire:model="codigo_oficina_contable"
                                                class="form-control" name="codigo_oficina_contable"
                                                id="codigo_oficina_contable" aria-label="Nombre"
                                                placeholder="Nombre">
                                            @error('nombre')
                                                <span class="text-danger">{{ $message }}</span>
                                                <style>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <label for="example-text-input" class="col-sm-12 col-form-label">Tipo de
                                        Calle</label>
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="tipoCalle" class="form-control"
                                            name="tipoCalle" id="tipoCalle" placeholder="Avenida/Plaza/Calle...">
                                        @error('tipoCalle')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="calle" class="form-control" name="calle"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" wire:model="numero" class="form-control"
                                            name="numero" id="numero" placeholder="1">
                                        @error('numero')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="direccionAdicional1" class="form-control"
                                            name="direccionAdicional1" id="direccionAdicional1"
                                            placeholder="Bloque/Letra...">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="direccionAdicional2" class="form-control"
                                            name="direccionAdicional2" id="direccionAdicional2"
                                            placeholder="Bloque/Letra...">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="direccionAdicional3" class="form-control"
                                            name="direccionAdicional3" id="direccionAdicional3"
                                            placeholder="Bloque/Letra...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" wire:model="codigoPostal" class="form-control"
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" wire:model="tlf1" class="form-control" name="tlf1"
                                            id="tlf1" placeholder="XXXXXXXXX">
                                        @error('tlf1')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" wire:model="tlf2" class="form-control" name="tlf2"
                                            id="tlf2" placeholder="Opcional">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" wire:model="tlf3" class="form-control" name="tlf3"
                                            id="tlf3" placeholder="Opcional">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="email1" class="form-control"
                                            name="email1" id="email1" placeholder="Email@email.com">
                                        @error('email1')
                                            <span class="text-danger">{{ $message }}</span>
                                            <style>
                                                .email1 {
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="email2" class="form-control"
                                            name="email2" id="email2" placeholder="email@email.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" wire:model="email3" class="form-control"
                                            name="email3" id="email3" placeholder="Email@email.com">
                                    </div>
                                </div>
                            </div> <!-- Confirmacion Email -->
                            <div class="form-group row">
                                <div class="col-sm-12 d-inline-flex align-items-center ms-5">
                                    <input class="form-check-input mt-0" wire:model="confPostal" type="checkbox"
                                        name="confPostal" id="confPostal">
                                ...
                                <div class="col-sm-12 d-inline-flex align-items-center ms-5">
                                    <input class="form-check-input mt-0" wire:model="confSms" type="checkbox"
                                        id="confSms">
                                    <label for="confSms" class="col-form-label">¿Deseas recibir una confirmación por
                                        SMS?</label>
                                </div>
                                <div class="col-sm-12 d-inline-flex align-items-center ms-5">
                                    <input class="form-check-input mt-0" wire:model="confEmail" type="checkbox"
                                        id="confEmail">
