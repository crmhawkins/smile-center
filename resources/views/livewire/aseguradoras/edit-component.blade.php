<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">EDITAR ASEGURADORA</span></h4>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-md-3">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="button" class="w-100 btn btn-success mb-2" id="alertaGuardar">Guardar Aseguradora</button>
                            <button type="button" class="w-100 btn btn-danger mb-2" wire:click='destroy'>Guardar Aseguradora</button>
                        </div>
                    </div>
                </div>
            </div>
