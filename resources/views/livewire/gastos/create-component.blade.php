<div class="container-fluid">
    ...
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">AÑADIR GASTO</span></h4>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card-body">
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" wire:model.defer="cuantia" class="form-control" placeholder="..." min="0" step="0.01">
                                    @error('cuantia')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" wire:model.defer="date" class="form-control" placeholder="15/02/2023">
                                    @error('date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
