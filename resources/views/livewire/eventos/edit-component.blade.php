...
<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">EVENTO <span style="text-transform: uppercase">{{$eventoNombre}}</span></h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Eventos</a></li>
                    <li class="breadcrumb-item active">Evento {{$eventoNombre}}</li>
                </ol>
            </div>
        </div> <!-- end row -->
    </div>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="form-group row mt-3">
                            <button type="button" wire:click="update"  class="btn btn-primary btn-lg waves-effect waves-light">Guardar</button>
                        </div>
