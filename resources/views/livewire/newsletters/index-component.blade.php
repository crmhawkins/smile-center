        ...
        <div class="col-md-12">
            <div class="block block-rounded">
                <div class="block-header d-flex align-items-center justify-content-between ">
                  ...
                  <a href="{{ route('newsletters.create') }}" class="btn btn-outline-secondary ml-5"><i class="icon-plus icons icon_l"></i> Añadir campaña de marketing</a>
                </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            @if($newsletters)
                                ...
                                <tr data-href="{{route('newsletters.edit', $newsletter->id)}}">
                                    <td>{{ $newsletter->id }}</td>
