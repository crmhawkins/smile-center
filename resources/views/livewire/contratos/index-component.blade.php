...
<div class="container-fluid mx-auto">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">TODOS LOS CONTRATO</span></h4>
            </div>
            <div class="col-sm-6">
            ...
            <tbody>
                @foreach ($contratos as $contrato)
                    <tr>
                        ...
                        <td>{{ $this->metodoPago($contrato->metodoPago) }}</td>
                        <td>{{ $this->getTotalDesc($contrato->id_presupuesto) }}%</td>
                        <td>{{ number_format($this->getTotal($contrato->id_presupuesto), 2, ",", ".") }}€</td>
                        <td>{{ $contrato->authImagen > 0 ? "Si" : "No" }}</td>
                        <td>{{ $contrato->authMenores > 0 ? "Si" : "No"}}</td>


                        <td> <a href="contratos-edit/{{ $contrato->id }}" class="btn btn-primary">Ver/Editar</a> </td>
                    </tr>
                @endforeach
            </tbody>
        </table>
