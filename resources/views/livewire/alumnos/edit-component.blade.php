    ...
    <br>
            ...
            <form wire:submit.prevent="update">
                    ...
                    <div class="col-sm-10" wire:ignore.self>
                        <select id="empresa" class="form-control js-example-responsive" wire:model="empresa_id">
                            ...
                            @foreach ($empresas as $emp)
                                <option value="{{ $emp->id }}" {{ $emp->id == $empresa_id ? 'selected': "" }}>{{ $emp->nombre }} </option>
                            @endforeach
                        </select>
                        @error('empresa')
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                      <input type="text" wire:model="apellidos" class="form-control" name="apellidos" id="apellidos" placeholder="Pérez">
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                        <input type="text" wire:model.defer="fecha_nac" class="form-control"  placeholder="18/02/2002" id="datepicker">
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                      <input type="text" wire:model="provincia" class="form-control" name="provincia" id="provincia" placeholder="Cádiz">
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                      <input type="text" wire:model="cod_postal" class="form-control" name="cod_postal" id="cod_postal" placeholder="11749">
                      @error('cod_posta') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex align-items-center">
                    ...
                    <div class="col-sm-10">
                      <input type="text" wire:model="movil" class="form-control" name="movil" id="movil" placeholder="654138955">
