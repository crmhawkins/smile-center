        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item active">Todos los monitores</li>
                </ol>
            </div>
        </div> <!-- end row -->
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Listado de todos los monitores</h4>
                            ...
                            <tbody>
                                @foreach ($monitores as $monitor)
                                    <tr>
                                        ...
                                        <td>{{ date("d/m/Y", strtotime($monitor->fechaNa)) }}</td>
                                        <td>{{ $monitor->localidad }}</td>
