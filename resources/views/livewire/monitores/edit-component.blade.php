                    ...
                    <form wire:update.prevent="update">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" wire:model="nombre" class="form-control" name="nombre" id="nombre" placeholder="José Carlos...">
                                    @error('nombre')
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <label for="example-text-input" class="col-sm-12 col-form-label">Fecha de nacimiento</label>
                                <div class="col-sm-11">
                                    <input type="date-local" wire:model="fechaNa" class="form-control" name="fechaNa" id="datepicker" placeholder="15/02/2023">
                                    @error('fechaNa')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" wire:model="localidad" class="form-control" name="localidad" id="localidad" placeholder="Localidad">
                                    @error('localidad')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" wire:model="telefono" class="form-control" name="telefono" id="telefono" placeholder="123456...">
                                    @error('telefono')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
