<div class="container-fluid">
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-sm-6">
                <h4 class="page-title">EDITAR LEAD</span></h4>
            </div>
            <div class="col-sm-6">
                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <label for="estado_id" class="col-sm-12 col-form-label">Estado</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 d-inline-flex align-items-center mt-4">
                                    <input class="form-check-input mt-0 ml-4" wire:model.lazy="newsletter" type="checkbox"
                                        name="newsletter" id="newsletter">
                                    <label for="confPostal" class="col-form-label ml-5">¿Newsletter?</label>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-md-3">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="w-100 btn btn-success mb-2" id="alertaGuardar">Guardar Lead</button>
                            <button type="button" class="w-100 btn btn-danger mb-2" wire:click='destroy'>Borrar Lead</button>
                        </div>
                    </div>
                </div>
            </div>
